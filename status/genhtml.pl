...
my %untranslated = (
    ...
    "uk" => "îÅÐÅÒÅËÌÁÄÅÎÏ",
    "wa" => "n&eacute;n co ratourn&eacute;s",
    "zh_TW" => "æœªç¿»è­¯"
);
...
my %lasttranslator = (
    ...
    "es" => "Último traductor",
    "et" => "Viimane t&otilde;lkija",
    "fr" => "Dernier traducteur",
    "gl" => "Último traductor",
	"it" => "Ultimo traduttore",
    "ja" => "ºÇ½ªËÝÌõ¼Ô",
    "nl" => "Laatst vertaald door",
    "nn" => "Siste omsetjar",
    "pt" => "Último tradutor",
...
my %details = ( 
    ...
    "et" => "GNOME'i eesti t&otilde;lgete olukorra detailne aruanne",
    "eu" => "Euskara (eu) itzulpenaren txosten xehetua",
    ...
    "it" => "Statistiche dettagliate per le traduzioni italiane di GNOME",
    "ja" => "ÆüËÜ¸ì(Japanese)ËÝÌõ¾õ¶·¾ÜºÙ¥ì¥Ý¡¼¥È",
    "nl" => "Gedetailleerd rapport voor vertaling van GNOME naar het Nederlands",
    ...
    "wa" => "Sipepieus rapoirt po les walons (wa) ratournaedjes di GNOME",
    "zh_TW" => "ç¹é«”ä¸­æ–‡ç¿»è­¯ç‹€æ³è©³ç´°å ±å‘Š"
);
