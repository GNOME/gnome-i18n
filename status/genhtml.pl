...
"da", "Detaljeret statistik for underst&oslash;ttelse af dansk i GNOME\n Detailed report for Danish (da) GNOME translations",
"de", "Detaillierte Statistik f&uuml; deutsche &Uuml;bersetzung in GNOME\n Detailed report for German (de) GNOME translations",
...
"no", "Detaljert rapport for oversettelse av GNOME til norsk\n Detailed report for Bokmaal Norweigian (no) GNOME translations",
...
"sv", "Detaljerad rapport f&ouml;r st&ouml;d av svenska i GNOME\n Detailed report for Swedish (sv) GNOME translations",
"tr", "TЭrkГe GNOME tercЭmeleri iГin geliЧmiЧ durum raporu\n Detailed report for Turkish (tr) GNOME translations",
"uk", "Детальний зв╕т про стан перекладу GNOME на укра╖нську\n Detailed report for Ukrainian (uk) GNOME translations",
