...
@langs = ( "bg", "ca", "cs", "cy", "da","de", "el", "en_GB", "es", 
...
open (TABLE, ">$htmldir/status-april.shtml") || die("can't open $htmldir/status-april.shtml");
print TABLE <<'EOF';
...
foreach $lang (@langs) {
    ...
    print TABLE "<td align=center><a href=\"details-april.shtml#$lang\"><font face=\"arial, helvetica\" size=2>$langs_red</font></a></td>\n";
}
print TABLE "</tr>\n";
...
#  print "$translated{$lang} / $totals = $percent, num: $num ($lang)\n";  
  ...
  print TABLE "<tr>";                                                                          
    foreach $lang (@langs_red) {
        print TABLE "<td align=center><a href=\"details-april.shtml#$lang\"><font face=\"arial, helvetica\" size=2>$lang</font></a></td>\n";
} 
print "\n";
...
open (REPORT, ">$htmldir/details-april.shtml") || die("can't open $htmldir/details-april.shtml");
